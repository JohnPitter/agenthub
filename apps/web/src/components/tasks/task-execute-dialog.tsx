        ...
        <div className="flex flex-col gap-4">
          ...
          <div>
            ...
            {availableTasks.length > 0 ? (
              ...
              <div className="rounded-xl border border-edge bg-page px-4 py-3 text-[13px] text-text-placeholder">
            ...
            {selectedTaskId && (() => {
              ...
              if (!task) return null;
              return (
                <div className="mt-2 rounded-xl bg-page p-3">
          ...
          <div className="mt-2 flex justify-end gap-3">
            ...
            <button
              ...
              disabled={!canExecute}
              className="flex items-center gap-2 rounded-xl bg-primary px-6 py-2.5 text-[14px] font-medium text-white shadow-sm transition-all hover:bg-primary-hover active:scale-[0.98] disabled:opacity-40"
            >
