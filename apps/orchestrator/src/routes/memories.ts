...
memoriesRouter.get("/:agentId/memories", async (req, res) => {
  try {
    ...
    logger.error(`Failed to list memories: ${error}`, "memories-route");
...
memoriesRouter.post("/:agentId/memories", async (req, res) => {
  try {
    ...
    logger.error(`Failed to store memory: ${error}`, "memories-route");
...
memoriesRouter.delete("/:agentId/memories/:memoryId", async (_req, res) => {
  try {
    ...
    logger.error(`Failed to delete memory: ${error}`, "memories-route");
