  ...
  if (process.env.NODE_ENV === "production") {
    res.setHeader(
      ...
      [
        ...
        "connect-src 'self' wss: wss://*.webcontainer.io https://openrouter.ai https://api.github.com https://*.webcontainer.io https://*.stackblitz.com https://stackblitz.com",
        "frame-src 'self' https://*.webcontainer.io https://*.stackblitz.com https://stackblitz.com blob:",
