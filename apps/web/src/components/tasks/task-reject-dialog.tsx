        ...
        <div className="flex flex-col gap-4">
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full resize-none rounded-xl border border-edge bg-page px-4 py-3 text-[14px] text-text-primary placeholder-text-placeholder outline-none transition-all focus:border-red focus:ring-2 focus:ring-red/20"
              autoFocus
            />
          </div>
          ...
          <div className="flex justify-end gap-3">
            ...
            <button
              ...
              className="rounded-xl bg-red px-5 py-2.5 text-[14px] font-medium text-white shadow-sm transition-all hover:opacity-90 active:scale-[0.98] disabled:opacity-40"
            >
